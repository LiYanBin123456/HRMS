...
public class RuleMedicalDao {
    ...
    public DaoQueryListResult getMedicalRules(Connection conn, QueryParameter param){
        ...
        return DbUtil.getList(conn,"rule_medical",param, RuleMedical.class);
    }

    public DaoQueryResult getMedicalRule(Connection conn, long id) {
        QueryConditions conditions = new QueryConditions();
        conditions.add("id","=",id);
        return DbUtil.get(conn,"rule_medical",conditions,RuleMedical.class);
    }

    public DaoUpdateResult updateMedicalRule(Connection conn, RuleMedical m) {
    ...
    public DaoUpdateResult insertMedicalRule(Connection conn, RuleMedical m) {
