...
public class ServeDao {
    //添加合同服务项目
    public DaoUpdateResult insert(Connection conn, Serve s){
    ...
    //修改合同服务项目
    public DaoUpdateResult update(Connection conn,Serve s){
    ...
    //获取合作客户的所有合同服务项目
    public DaoQueryListResult getList(Connection conn, QueryParameter param,long id){
