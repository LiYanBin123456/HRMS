...
public class Detail2Service {
    ...
    public static DaoUpdateResult importDetails(Connection conn, long sid, List<ViewDetail2> ViewDetail2s){
        ...
        for(ViewDetail2 v2 :ViewDetail2s){
            ...
            if(employee==null){
                result.msg="员工"+v2.getName()+"不存在，或者身份证错误，请核对";
            }
            Detail2 detail2 = new Detail2(0,sid,employee.getId(),v2.getMonth(),v2.getHours(),v2.getPrice(),v2.getFood()
